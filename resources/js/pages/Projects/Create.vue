          ...
          <v-card-text>
            <v-form ref="formRef" @submit.prevent="submitForm">
              ...
              <div class="mb-6">
                ...
                <div v-if="locationError" class="mt-2 p-3 bg-red-50 border border-red-200 rounded-md">
                  <div class="flex">
                    ...
                    <div class="ml-3">
                      ...
                      <p class="text-xs text-red-600 mt-1" v-if="locationError.includes('denied')">
                        To use this feature, please allow location access in your browser settings and try again.
                      </p>
                      <p class="text-xs text-red-600 mt-1" v-else-if="locationError.includes('unavailable')">
                        Location services are not available. Please enter the location manually below.
                      </p>
                      <p class="text-xs text-red-600 mt-1" v-else-if="locationError.includes('timeout')">
